...
{
    public sealed class TrajectoryPointSummary
    {
        ...
        public List<TracePointSnapshot> FirstPoints { get; set; } = new List<TracePointSnapshot>();
        public List<TracePointSnapshot> LastPoints { get; set; } = new List<TracePointSnapshot>();
    }
}
